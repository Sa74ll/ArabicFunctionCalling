...
$$ h = W_{0}x + \frac{\alpha}{r}(A \times B)x $$

- **$W_{0}$ (Frozen Weights):** The pre-trained weights from Google.
...
The learning rate $\eta$ at step $t$ follows:
